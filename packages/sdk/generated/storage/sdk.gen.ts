...
export class Sdk extends HeyApiClient {
     ...
     */
    public createDecisionHandler<ThrowOnError extends boolean = false>(options: Options<CreateDecisionHandlerData, ThrowOnError>): RequestResult<CreateDecisionHandlerResponses, CreateDecisionHandlerErrors, ThrowOnError> {
        return (options.client ?? this.client).post<CreateDecisionHandlerResponses, CreateDecisionHandlerErrors, ThrowOnError>({
