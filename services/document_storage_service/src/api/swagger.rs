...
#[openapi(
    ...
    paths(
        ...
        documents_hex::inbound::axum_router::create_decision::create_decision_handler,
    ...
    components(
        schemas(
            ...
            documents_hex::domain::models::CreateDecisionRequest,
            documents_hex::domain::models::CreateDecisionResponse,
